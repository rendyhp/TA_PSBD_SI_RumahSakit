    ...
    <body  class="main-body light-theme app sidebar-mini active leftmenu-color">
		...
		<aside class="app-sidebar">
			...
			<div class="main-sidemenu sidebar-scroll">
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="/data_pasien"><div class="side-angle1"></div><div class="side-angle2"></div><div class="side-arrow"></div>
                    <i class="fas fa-users" style="font-size:22px; margin-right:10px"></i>
						<span class="side-menu__label">Data Pasien</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="/data_dokter"><div class="side-angle1"></div><div class="side-angle2"></div><div class="side-arrow"></div>
                    <i class="fas fa-user-md" style="font-size:20px; margin-right:12px"></i>
						<span class="side-menu__label">Data Dokter</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="/data_poliklinik"><div class="side-angle1"></div><div class="side-angle2"></div><div class="side-arrow"></div>
                    <i class="far fa-calendar-alt" style="font-size:20px; margin-right:12px"></i>
						<span class="side-menu__label">Data Poliklinik</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="/data_obat"><div class="side-angle1"></div><div class="side-angle2"></div><div class="side-arrow"></div>
                    <i class="fas fa-bed" style="font-size:17px; margin-right:9px"></i>
						<span class="side-menu__label">Data Obat</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="/data_rekammedis"><div class="side-angle1"></div><div class="side-angle2"></div><div class="side-arrow"></div>
                    <i class="fas fa-procedures" style="font-size:17px; margin-right:9px"></i>
						<span class="side-menu__label">Rekam Medis</span></i></a>
							</li>
		...
		<div class="main-footer ht-40">
			<div class="container-fluid pd-t-0-f ht-100p">
				<span>Copyright © 2023 <a href="#">SI Rumah Sakit</a></span>
			</div>
		</div>
		<!-- Footer closed -->
        <!-- Back-to-top -->
