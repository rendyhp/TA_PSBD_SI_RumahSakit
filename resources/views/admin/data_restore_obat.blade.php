...
@section('title', 'Data Restore Obat')
            ...
            <div class="container-fluid mg-t-20">
				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="left-content">
						<h4 class="content-title mb-1">Data Restore Obat</h4>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							...
							<a href="/data_obat">Kembali</a>
							    <form method="post" action="/cari_restore_obat">
							        @csrf
						...
						<?php $i = ($tb_obat->currentPage()*10) - 9 ?>
						 @foreach($tb_obat as $d)					<tr>
                            ...
                            <button type="submit" class="btn d-inline"><i class="fas fa-sync-alt" onclick="return confirm('Yakin mau merestore data {{$d->nama_obat}} ini?')"></i></button>
                            </form>
