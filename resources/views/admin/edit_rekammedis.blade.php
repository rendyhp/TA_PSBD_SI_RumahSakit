    ...
    <div class="container-fluid mg-t-20">
				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="left-content">
						<h4 class="content-title mb-1">Edit rekammedis</h4>
				...
				<div class="row row-sm">
					...
					<div class="col-xl-12">
                        ...
                        <form method="post" action="/update_rekammedis">
                            @csrf
                            <input type="hidden" value="{{$data->id_rm}}" name="id_rm">
                        
                            <div class="mb-3">
                                <label for="id_pasien">Id Pasien</label>
                                <select class="form-control m-bot15" name="id_pasien" id="id_pasien" required>
                                    @foreach($datas as $dataE)
                                        <option value="{{ $data->id_pasien }}" <?php {echo 'selected';} ?>>{{ $dataE->nama_pasien }}</option> 
                                    @endforeach
                                </select>
                            </div>
